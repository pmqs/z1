...
/* More modern Win32 compilers now have published fseeki64
 * and ftelli64 functions.  If they can be found, by the
 * time we get here zfseeko and zftello should already point
 * to them.  If not, the below are used.
 */
# ifndef zftello
